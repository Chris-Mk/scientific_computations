...
from masters.spectroscopy.intensityCorrectedWMS import intensity_corrected_WMS
...
# Path
filepath_signal = "./masters/spectroscopy/files/ABS/GASMAS158cm_Extra.txt"
...
RAM_info = {
    ...
    'nHarmonic': 1  # Harmonic to calculate
}
...
wms_temp = intensity_corrected_WMS(RAM_signal, RAM_info, 0)
